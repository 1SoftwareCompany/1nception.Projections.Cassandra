...
public class CassandraProjectionStoreNewInitializerTests
{
    ...
    CassandraProjectionStoreInitializer initializerNew;
    ...
    public async Task SetUp()
    {
        ...
        var projectionStoreNew = new CassandraProjectionStoreSchema(contextAccessor.Object, cassandra, replicatoinStrategy, NullLogger<CassandraProjectionStoreSchema>.Instance);

        initializerNew = new CassandraProjectionStoreInitializer(partitionSchema, naming, projectionStoreNew);
    }
...
{
    ISession session;
    CassandraProjectionStore projectionStore;
    VersionedProjectionsNaming naming;
    ...
    public async Task SetUp()
    {
        ...
        naming = new VersionedProjectionsNaming();
        projectionStore = new CassandraProjectionStore(contextAccessor.Object, cassandra, partitionStore, serializer, naming, NullLogger<CassandraProjectionStore>.Instance);
        var replicatoinStrategy = new SimpleReplicationStrategy(1);
