...
using One.Inception.Persistence.Cassandra;
using One.Inception.Projections.Cassandra.Infrastructure;
using One.Inception.Projections.Cassandra.PrepareStatements.New;
...
{
    public CassandraProjectionStore(IInceptionContextAccessor inceptionContextAccessor, TSettings settings, ILogger<CassandraProjectionStore> logger) : base(inceptionContextAccessor, settings.CassandraProvider, settings.Partititons, settings.Serializer, settings.ProjectionsNamingStrategy, logger) { }
}
...
public partial class CassandraProjectionStore : IProjectionStore
{
    ...
    public CassandraProjectionStore(IInceptionContextAccessor inceptionContextAccessor, ICassandraProvider cassandraProvider, IProjectionPartionsStore projectionPartionsStore, ISerializer serializer, VersionedProjectionsNaming naming, ILogger<CassandraProjectionStore> logger)
    {
        ...
        _insertPreparedStatement = new InsertPreparedStatementNew(inceptionContextAccessor, cassandraProvider);
        _insertPartitionPreparedStatementNew = new InsertPartitionPreparedStatementNew(inceptionContextAccessor, cassandraProvider);
        _preparedStatementToGetProjectionNew = new PreparedStatementToGetProjectionNew(inceptionContextAccessor, cassandraProvider);
        _asOfDatePreparedStatementNew = new AsOfDatePreparedStatementNew(inceptionContextAccessor, cassandraProvider);
        _descendingPreparedStatementNew = new DescendingPreparedStatementNew(inceptionContextAccessor, cassandraProvider);
    }
