...
public class CassandraProjectionPartitionsStore : IProjectionPartionsStore
{
    ...
    public CassandraProjectionPartitionsStore(IInceptionContextAccessor inceptionContextAccessor, ICassandraProvider cassandraProvider, ILogger<CassandraProjectionPartitionsStore> logger)
    {
        if (cassandraProvider is null) throw new ArgumentNullException(nameof(cassandraProvider));

        _readPreparedStatement = new ReadPreparedStatement(inceptionContextAccessor, cassandraProvider);
        _writePreparedStatement = new WritePreparedStatement(inceptionContextAccessor, cassandraProvider);
    ...
    {
        public ReadPreparedStatement(IInceptionContextAccessor context, ICassandraProvider cassandraProvider) : base(context, cassandraProvider) { }
    ...
    {
        public WritePreparedStatement(IInceptionContextAccessor context, ICassandraProvider cassandraProvider) : base(context, cassandraProvider) { }
